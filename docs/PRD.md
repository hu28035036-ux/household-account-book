...
- **상세 자료**: [`docs/sbiz/소상공인_가계부_확장_계획.md`](sbiz/소상공인_가계부_확장_계획.md) — 시장 분석·MVP 범위·국세청 간편장부·증빙 5년 보관·3만원 초과 법정증빙 등. [`docs/sbiz/가계부앱_유저확보_리서치.xlsx`](sbiz/가계부앱_유저확보_리서치.xlsx) — 유저 확보 리서치.
...
- **자영업자 간단 회계 모드** — 박사장 페르소나의 Beachhead 진입 가설. 상세 확장 계획·MVP 범위·국세청 간편장부 참고는 [`docs/sbiz/소상공인_가계부_확장_계획.md`](sbiz/소상공인_가계부_확장_계획.md), 유저 확보 리서치는 [`docs/sbiz/가계부앱_유저확보_리서치.xlsx`](sbiz/가계부앱_유저확보_리서치.xlsx).
